<template>
  <ul>
    <li
      ...
      ${'/app/' + this.$route.name === item.link ? 'menu-item-active' : ''}
    ...
    <li class="single-sidebar-menu">
      <a
      href="https://www.youtube.com/playlist?list=PLVAzIU2-inJq7icoc7frFipd7EFTJIind"
        class="menu-link"
      >
        <span class="menu-icon"><Icon icon="heroicons-outline:academic-cap" /></span>
        <div class="text-box">Tutorias</div>
      </a>
    </li>
    <li class="single-sidebar-menu">
      <button
        ...
        class="menu-link"
      >
        <span class="menu-icon"><Icon icon="heroicons-outline:chat-bubble-left-right" /></span>
        <div class="text-box">Suporte</div>
      </button>
    </li>
    <li class="single-sidebar-menu">
      <button
      @click="redirectLink('/app/settings')"
        class="menu-link"
      >
        <span class="menu-icon"><Icon icon="heroicons-outline:cog" /></span>
        <div class="text-box">Configurações</div>
      </button>
    </li>
    <li class="single-sidebar-menu">
      <button
        ...
        class="menu-link"
      >
        <span class="menu-icon"><Icon icon="heroicons-outline:arrow-left-on-rectangle" /></span>
        <div class="text-box">Sair</div>
      </button>
    </li>
  </ul>
</template>
...
export default {
  ...
  methods: {
    ...
    openWhatsApp() {
            const url = 'https://wa.me/'+ process.env.VUE_APP_SUPPORT_NUMBER + '?text=Olá, preciso de ajuda no 123Rifas.'; // URL do WhatsApp com o número de telefone
