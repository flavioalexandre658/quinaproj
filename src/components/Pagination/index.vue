    ...
    <ul class="pagination" :class="paginationClass">
      <li class="text-xl leading-4 text-slate-900 dark:text-white">
        ...
        >
          ...
          <span v-if="enableText" class="text-sm">Anterior</span>
        </button>
      </li>
      ...
      <li class="text-xl leading-4 text-slate-900 dark:text-white">
        ...
        >
          ...
          <span v-if="enableText" class="text-sm">Próximo</span>
        </button>
      </li>
    </ul>
  </div>
...
export default defineComponent({
  ...
  methods: {
    ...
    customPerPageChange(newPerPage) {
      if (this.perPageChanged) {
        this.perPageChanged(newPerPage);
      }
    },
  },
  computed: {
