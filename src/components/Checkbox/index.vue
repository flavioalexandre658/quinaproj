<template>
  <div>
    ...
    >
      ...
      <span
        class="h-4 w-4 border flex-none border-slate-400 dark:border-slate-800 rounded inline-flex mr-3 relative transition-all duration-150"
        :class="
          ck
            ? activeClass + ' ring-2 ring-offset-2 dark:ring-offset-slate-800 '
            : 'bg-slate-400 dark:bg-slate-600 dark:border-slate-600'
        "
      >
        <img
